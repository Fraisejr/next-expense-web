...
- The revenue year follows invoice months: December work is assigned to the following January. Within that year, all timesheet hours entered through today count as earned for planning, even before their invoice is booked. Client rates are effective-dated against the invoice month so later rate changes do not rewrite earlier revenue. Bank income remains the separate cash-received view.
- Revenue forecasts start tomorrow and use client-level forecast hours per weekday through the end of the revenue year, less vacation days remaining. Future daily time entries are not required for forecasting.
