...
- Timesheet revenue is earned in the period when client work is recorded. Client rates are effective-dated so later rate changes do not rewrite earlier revenue. Bank income remains the separate cash-received view.
- Revenue forecasts use client-level weekly hours for the remaining full weeks of the year, less planned vacation weeks. Future daily time entries are not required for forecasting.
