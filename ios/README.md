...
missing payee, category, or both. **Approve all ready** confirms and approves
only the green items, leaving incomplete imports in Review. A batch stops on the
first error and reports how many transactions were saved.
